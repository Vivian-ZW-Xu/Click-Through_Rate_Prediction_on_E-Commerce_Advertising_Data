...
DAILY_BEHAVIOR_PATH = Path(
    "data/processed_v2/behavior/user_daily_behavior.parquet"
)
BASE_DIR = Path("data/processed_v2/base")
LOOKUP_DIR = Path("data/processed_v2/behavior/window_features")
OUTPUT_DIR = Path("data/processed_v2/features")
